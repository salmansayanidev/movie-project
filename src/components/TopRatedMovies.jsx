                                            ...
                                            TopRatedMovies.map( (TopRatedMovie , index ) => (
                                                <Link key={index} to={`/movie/${TopRatedMovie.id}`}>
                                                    <div className='popularmovie'>
                                                        ...
                                                        <div className='abc'>
                                                            <CircularProgressbar styles={buildStyles({ backgroundColor: "black" })} background backgroundPadding={6} value={(TopRatedMovie.vote_average * 10).toFixed()} text={`${(TopRatedMovie.vote_average * 10).toFixed()}%`} />
                                                        </div>
                                                    </div>
                                                </Link>
                                            ))
