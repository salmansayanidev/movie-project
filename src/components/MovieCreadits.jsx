                            ...
                            movieCreadits.cast.map((movieCreadit , index) => {
                                ...
                                <SwiperSlide key={index}>
                                    <div className='creaditsMovie-div'>
                                        <Link className='creaditsMovie' to={`/person/${movieCreadit.id}`}>
                                            <img className='img-fluid' src={movieCreadit.profile_path ?  "https://image.tmdb.org/t/p/w500/" +movieCreadit.profile_path : DummyProfile } alt="" />
                                            <h2>{movieCreadit.name}{movieCreadit.original_name}</h2>
